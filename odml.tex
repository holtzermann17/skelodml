...
The \href{Digital Public Library of America}{http://dp.la/info/} (DPLA) provides \href{https://lists.dp.la/listinfo}{mailing lists} and \href{http://dp.la/apps}{tools}, connecting users to a range of library resources.
